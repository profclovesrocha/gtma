# DATAS DAS ENTREGAS
- DESAFIO 1: (da AULA 3) entrega: 10/Mar/2026
    01. Desafio 1: Praticando o Manifesto Ágil
    Agora é a sua vez de colocar em prática os conceitos que aprendemos! Este desafio prático visa
...
- DESAFIO 2: (da AULA 4) entrega: 16/Mar/2026
  ...
  02. Formação de Times Multidisciplinares
  Estudantes organizados em equipes diversas aplicam conceitos teóricos em cenários práticos reais da disciplina.
  
  03. Entregas Incrementais
  Desenvolvimento contínuo de funcionalidades em sprints curtos, permitindo ajustes baseados em feedback constante.
  
  04. Colaboração Contínua
  Comunicação diária, reuniões de sincronização e compartilhamento de conhecimento entre todos os membros da equipe.
...
- Time 04: Carlos Eduardo de Vasconcelos, Flávia Carvalho, Júlia Coimbra, Adriane Vitoria e Gabrielle Sofia e Dimitris.
